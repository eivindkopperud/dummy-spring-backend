...
COPY --from=build /home/app/target/dummy-spring-backend-0.0.1-SNAPSHOT.jar /usr/local/lib/app.jar
EXPOSE 8080
...
ENTRYPOINT java -Xmx6G -jar -Dspring.profiles.active=$ENV_NAME /usr/local/lib/app.jar
